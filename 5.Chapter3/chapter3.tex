...
\end{subfigure}
\caption{Heatmaps illusstrating the timeline position of selections made by participants. Mean selection position is indicated (note that the mean timeline length was 14)}
\end{figure}
