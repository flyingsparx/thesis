...
\begin{subfigure}{.5\textwidth}
    ...
    \begin{tikzpicture}[scale=0.8]
     \begin{axis}[
        ...
        minor grid style={draw opacity=0},
        major grid style={draw opacity=0},
