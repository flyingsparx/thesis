...
\centering
    \begin{tikzpicture}
     \begin{loglogaxis}[
            xlabel=Maximum path-length of $G(t)$,
...
\centering
    ...
    \begin{axis}[
        symbolic x coords={1,2,3,4,5,6},
            ylabel=Likelihood of citation of $t.\textrm{author}_O$,
            xlabel=Maximum path-length of $G(t)$,
            ymin=0,
            ymax=100,
            ybar,
...
\begin{subfigure}{.5\textwidth}
    ...
    \begin{axis}[
            ylabel=Mean distinct audience size of $G(t)$,
            xlabel=Maximum path-length of $G(t)$,
            grid=major,
            xmin=1]
       \addplot[mark=+,only marks,blue] plot coordinates{
...
\begin{subfigure}{.5\textwidth}
    ...
    \begin{tikzpicture}[scale=0.8]
    \begin{semilogyaxis}[
            ylabel=Mean immediate  audience size of $G(t)$,
            xlabel=Maximum path-length of $G(t)$,
            grid=major,
            xmin=1]
       \addplot[mark=+,only marks,blue] plot coordinates{
...
\begin{subfigure}{.5\textwidth}
    ...
    \begin{tikzpicture}[scale=0.8]
    \begin{axis}[
            ylabel=Largest overhead of $G(t)$,
            xlabel=Maximum path-length of $G(t)$,
            grid=major,
            xmin=1
           ]
...
\begin{subfigure}{.5\textwidth}
    ...
    \begin{tikzpicture}[scale=0.8]
    \begin{axis}[
            ylabel=Mean proportionate overhead of $G(t)$,
            xlabel=Maximum path-length of $G(t)$,
            grid=major,
            xmin=1
            ]
...
\begin{subfigure}{.5\textwidth}
    ...
    \begin{tikzpicture}[scale=0.8]
    \begin{axis}[
            ylabel=Largest proportionate overhead of $G(t)$,
            xlabel=Maximum path-length of $G(t)$,
            grid=major,
            xmin=1
           ]
...
\end{subfigure}
\caption{Relationships between $G(t)$'s audience overhead properties and its maximum path-length $\forall t \in T`$, where $T`$ is the set of analysed Tweets}
\end{figure}
...
\centering
    \begin{tikzpicture}
    \begin{axis}[
            ylabel=Mean $\textrm{deg}^+(t.\rextrm{author}_O$),
            xlabel=Maximum path-length of $G(t)$,
            grid=major,
            xmin=1,
            width=8cm]
...
\centering
    \begin{tikzpicture}
    \begin{axis}[
            ylabel=Chance of $r.\textrm{author}_R \in t.\rextrm{author}_O.E_i$,
            xlabel=$h$,
            grid=major,
            xmin=1,
            width=8cm]
